...
muon-electron mass ratio, the tau-electron mass ratio, and the Higgs boson
mass emerge from the spectral geometry of the BCC lattice Dirac operator.
The framework takes two inputs---the BCC coordination number $n = 8$ and the
transcendental $\pi$---with $d = 3$ (spatial dimensions) entering the muon,
tau, and Higgs formulas, and produces values for all five constants with zero
free parameters. The Higgs prediction (125.108~GeV) is genuinely
predictive---it selects the ATLAS value over CMS and is falsifiable at the
HL-LHC. I am writing to ask whether you can see a trivial explanation for the
coincidences below, or whether the lattice selection mechanism has structural
content.
...
% -- 8 --
\subsection*{8.\ Lattice Selection: Why BCC?}
...
% -- 9 --
\subsection*{9.\ Questions for the Reader}
