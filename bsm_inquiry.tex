...
muon-electron mass ratio, and the tau-electron mass ratio emerge from the
...
$\pi$---with $d = 3$ (spatial dimensions) entering the muon and tau
formulas, and produces values for all four constants with zero free
parameters. I am writing to ask whether you can see a trivial explanation
for the coincidences below, or whether the lattice selection mechanism has
structural content.
...
% -- 7 --
\subsection*{7.\ Lattice Selection: Why BCC?}
...
% -- 8 --
\subsection*{8.\ Questions for the Reader}
